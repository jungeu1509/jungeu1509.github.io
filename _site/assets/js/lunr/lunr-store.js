var store = [{
        ...
        "tags": ["test"],
        "url": "http://localhost:4000/uncategorized/test/test/",
        "teaser": null
      },{
        "title": "마크다운(Markdown) 작성법",
        "excerpt":"출처 : https://gist.github.com/ihoneymon/652be052a0727ad59601 [공통] 마크다운 markdown 작성법 1. 마크다운에 관하여 1.1. 마크다운이란? Markdown은 텍스트 기반의 마크업언어로 2004년 존그루버에 의해 만들어졌으며 쉽게 쓰고 읽을 수 있으며 HTML로 변환이 가능하다. 특수기호와 문자를 이용한 매우 간단한 구조의 문법을 사용하여 웹에서도 보다 빠르게 컨텐츠를 작성하고 보다 직관적으로 인식할 수 있다. 마크다운이 최근 각광받기 시작한...","categories": ["Uncategorized"],
        "tags": ["markdown"],
        "url": "http://localhost:4000/uncategorized/%EB%A7%88%ED%81%AC%EB%8B%A4%EC%9A%B4_%EC%9E%91%EC%84%B1%EB%B2%95/",
        "teaser": null
      }]
